...
- `check_spelling_live`: Misspelled words with the address of each and the dictionary's suggestions; judged per text run's own language, and a language with no dictionary is named rather than reported as all wrong
