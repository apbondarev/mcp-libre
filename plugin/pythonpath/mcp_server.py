...
class LibreOfficeMCPServer(BatchTools, ReviewTools, FieldTools, BookmarkTools, ReferenceTools, IndexTools, TableShapeTools, TableTools, CommentTools, ImageTools, 
