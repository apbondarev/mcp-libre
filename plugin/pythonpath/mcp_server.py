...
class LibreOfficeMCPServer(BatchTools, ReviewTools, FieldTools, BookmarkTools, ReferenceTools, IndexTools, NoteTools, SectionTools, HeaderTools, TableShapeTools, TableTools, CommentTools, ImageTools, 
