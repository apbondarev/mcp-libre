...
class LibreOfficeMCPServer(BatchTools, ReviewTools, FieldTools, BookmarkTools, ReferenceTools, IndexTools, NoteTools, SectionTools, TableShapeTools, TableTools, CommentTools, ImageTools, 
