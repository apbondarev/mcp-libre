...
class LibreOfficeMCPServer(BatchTools, ReviewTools, FieldTools, BookmarkTools, ReferenceTools, IndexTools, NoteTools, TableShapeTools, TableTools, CommentTools, ImageTools, 
